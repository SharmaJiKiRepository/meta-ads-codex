...
[Reads meta-ads/references/voice-to-style.md to map brand voice axes to visual attributes]
[Reads ~/.codex/skills/meta-ads/references/meta-creative-specs.md for placement safe zones]
...
4. **Read `meta-ads/references/voice-to-style.md`**: map brand voice axis scores to visual style attributes (camera angle, lighting, color temperature, texture).

5. **Read platform creative spec reference** for each platform in the brief:
   - `~/.codex/skills/meta-ads/references/meta-creative-specs.md` (Feed, Reels, Stories, Threads, Messenger, Audience Network safe zones)
...
5. **[STYLE]**: Read `meta-ads/references/voice-to-style.md`, map brand voice axis scores to visual attributes. Add camera/lens spec and prestigious reference.
...
| Placement            | Append to prompt                                                          |
|----------------------|---------------------------------------------------------------------------|
| Reels / Stories 9:16 | `", active visual centered in middle 70%, top 15% and bottom 20% minimal"` |
| Feed 4:5             | `", primary visual in upper 65%, bottom 30% minimal for copy overlay"`     |
| Feed 1:1             | `", centered composition with generous 20% margin all sides"`              |
| Carousel 1:1         | `", consistent centered subject, margin for card copy overlay"`           |
...
Generated [N] ad assets ([N/3] briefs x 3 A/B/C variations):
  ...
  ✓ ./ad-assets/meta/concept-1/reels-1080x1920-v1.png (1080x1920)
  ✗ ./ad-assets/meta/concept-1/right-col-1200x628-v1.png: ERROR [reason]

Variants: Upload v1, v2, and v3 to Meta Ads Manager. Run them in rotation to find the best performer.
